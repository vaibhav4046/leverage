...
const slides = [
  ...
  { shot: 'paper', h: 'Then it wrote<br>a paper.', sub: 'A position paper on delegating work to AI agents, held to tests: the sections, the length, six numbered references, and an evidence section that may only quote what a running system recorded. No invented experiments allowed, and the test checks for that too.' },
