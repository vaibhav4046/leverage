...
function systemPrompt(): string {
  return [
    ...
    'Rules: at most 8 tasks; every task names at least one file in fileScope; every task lists the',
    'test files that prove it done in referenceFiles; every task has exactly',
