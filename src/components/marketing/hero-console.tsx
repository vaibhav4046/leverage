...
export function HeroConsole({ run }: { run: MissionSnapshot | null }) {
  ...
  return (
    <div className="relative">
      ...
      <div className="surface-card relative z-30 p-5 shadow-[0_20px_35px_rgba(0,0,0,0.34),0_4px_13px_rgba(0,0,0,0.25)]">
      ...
      {/* Panel 2 — workforce */}
      <div className="surface-card relative z-20 -mt-2 ml-6 p-5 shadow-[0_20px_35px_rgba(0,0,0,0.34)] sm:ml-8">
      ...
      {/* Panel 3 — live tail */}
      <div className="surface-highlight relative z-10 -mt-2 ml-12 p-5 shadow-[0_20px_34px_rgba(0,0,0,0.35)] sm:ml-16">
